    ...
    >
      ...
      >
        ...
        <Section id="special" num="5" title="특수 칸 상세 규칙">
          ...
          <H3>💰 사회복지기금</H3>
          <Ul>
            <li><b>납부처(38번)</b>: 도착 시 15만원을 기금으로 납부</li>
            <li><b>접수처(20번)</b>: 도착 시 적립된 기금 <b>전액 수령</b></li>
            <li>황금열쇠 카드로도 기금 수령 가능</li>
          </Ul>

          <H3>🛸 우주여행</H3>
          <Ul>
            <li>도착하면 <b>랜덤 위치</b>로 이동</li>
            <li>컬럼비아호 증서 소유자에게 <b>통행료</b> 지불</li>
            <li>이동한 칸의 효과가 추가로 적용됨</li>
          </Ul>
        </Section>
        ...
        <Section id="goldenkey" num="6" title="황금열쇠 카드 (30장)">
          ...
          <Table
            ...
            rows={[
              ...
              ['🍊🌊🇰🇷 관광여행', '제주도 / 부산 / 서울로 이동'],
              ['🏝️ 무인도', '무인도로 즉시 이동'],
              ['💰 사회복지기금 수령', '기금 접수처(20번)로 이동'],
              ['🛸 우주여행 초대권', '우주여행 칸(30번)으로 이동'],
